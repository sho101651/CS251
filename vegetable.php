  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="menu.php">เมนูร้านค้า <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item ">
...
<div class="container mt-5">
  ...
  <div class="row">
	...
	<h1 class="my-4">Deliberger</h1>
      <div class="list-group">
        <a href="meat.php" class="list-group-item">Meat</a>
        <a href="vegetable.php" class="list-group-item">Vegetable</a>
        <a href="seafood.php" class="list-group-item">Seafood</a>
      </div>      
...
<?php 
	...
	include ("db.php");
	$vegetable = "vegetable";
	$sql = "SELECT product.`Product_ID` , product.`Product_name` , product.`Image_name` , product.`price`, product.`Description`, ingredients.`name`, ingredients.`type` FROM product,ingredients WHERE ingredients.`name` = product.`ingredient` AND ingredients.`type` = '".$vegetable."' ";
