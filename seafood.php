...
<?php 
	...
	include ("db.php");
	$seafood = "seafood";
	$sql = "SELECT product.`Product_ID` , product.`Product_name` , product.`Image_name` , product.`price`, product.`Description`, ingredients.`name`, ingredients.`type` FROM product,ingredients WHERE ingredients.`name` = product.`ingredient` AND ingredients.`type` = '".$seafood."' ";
